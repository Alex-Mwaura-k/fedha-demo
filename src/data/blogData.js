export const blogData = [
  ...
  <h4 class="fw-bold mt-4 text-secondary">1. An Accessible Entry Point into Real Estate</h4>
  ...
  <h4 class="fw-bold mt-4 text-secondary">2. High Market Demand and Stability</h4>
  ...
  <h4 class="fw-bold mt-4 text-secondary">3. Versatility in Development Potential</h4>
  ...
  <h4 class="fw-bold mt-4 text-secondary">4. Minimal Maintenance and Holding Costs</h4>
  ...
  <h4 class="fw-bold mt-4 text-secondary">5. Rapid Capital Appreciation in Emerging Zones</h4>
  ...
  <h4 class="fw-bold mt-4 text-secondary">6. High Liquidity and Ease of Resale</h4>
